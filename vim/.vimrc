...
set tabstop =4
set shiftwidth =2         " number of spaces to use for each step of indent set tabstop    =2         " number of spaces that a <Tab> in the file counts for
...
"-------------------------------------------------------------------------------
 noremap <silent> <s-F7>  <Esc><Esc>:Tlist<CR>
inoremap <silent> <s-F7>  <Esc><Esc>:Tlist<CR>
 noremap <silent> <F7>  <Esc><Esc>:NERDTreeToggle<CR>
 inoremap <silent> <F7>  <Esc><Esc>:NERDTreeToggle<CR>
